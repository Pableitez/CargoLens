...
export default {
  components: {
    ...
    shipmentHeader: {
      demoBanner:
        "Datos de demostración — la posición y hitos son simulados salvo que el servidor use API real.",
    ...
    locationCombobox: {
      ...
      noMatch: "Ninguna ubicación coincide con tu búsqueda.",
    },
    countryCombobox: {
      placeholder: "Buscar país por nombre o código…",
      toggleOptions: "Mostrar países",
      noMatch: "Ningún país coincide con tu búsqueda.",
    },
    entitySearchPicker: {
      placeholder: "Escribe para buscar…",
      toggleOptions: "Mostrar coincidencias",
      noMatch: "Sin coincidencias para tu búsqueda.",
      searchFailed: "No se pudo completar la búsqueda. Inténtalo de nuevo.",
      loading: "Buscando…",
      typeHint: "Escribe para filtrar — evita cargar un desplegable enorme.",
  ...
  overviewMap: {
    ...
    apiOnlyEmpty:
      "Aún no hay envíos con API de operador en el mapa. Abre Seguimiento para un contenedor, carga datos del operador, y podrá aparecer aquí. Otras filas guardadas pueden seguir en las tarjetas de arriba.",
    loadingMap: "Cargando mapa…",
    clickTooltip: "Clic para seguir",
    partialHint:
      "Algunos contenedores no tienen posición en mapa (sin datos del operador). Usa el resumen superior o Seguimiento.",
  },
  moduleList: {
    searchLabel: "Buscar",
    ...
    filterActive: "Activo",
    unifiedSearchPlaceholder: "Escribe para filtrar o fijar un valor…",
    discreteSearchPlaceholder: "Buscar o seleccionar…",
    toggleOptions: "Ver opciones",
    selectedValues: "Valores fijados",
    removeValue: "Quitar {{value}}",
    clearSelection: "Quitar valores fijados",
    ...
    noResults: "Ningún resultado coincide con tus filtros.",
