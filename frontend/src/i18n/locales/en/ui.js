...
export default {
  ...
  overviewMap: {
    ...
    apiOnlyEmpty:
      "No operator API shipments on the map yet. Open Tracking for a container, load operator data, then it can appear here. Other saved rows may still show in the cards above.",
    loadingMap: "Loading map…",
    clickTooltip: "Click to track",
    partialHint:
      "Some containers have no map position (no operator data). Use the summary above or Tracking.",
  },
  moduleList: {
    searchLabel: "Search",
