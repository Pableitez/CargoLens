...
export default {
  ...
  track: {
    homeTitle: "Container visibility",
    homeSubtitle:
      "Search any ISO below at no cost. For export orders, shipper bookings, and team workspace, start from the platform home.",
    mainTitle: "Tracking",
    ...
    embedHint:
      "Enter a container number (min. 4 characters). Operator data is not loaded automatically — use Track or “Load operator data” when you want live Safecube details.",
    ...
    homeLanding: {
      ...
      valueLead:
        "Public tracking costs nothing. The workspace adds what operators use every day — lists, map, clients, and imports.",
      card1Title: "Instant search",
      card1Body:
        "Type a container number and see milestones, vessel, map, and timeline when operator data is available.",
      ...
      card3Body:
        "Company codes for staff and per-client invites. Everyone sees only the shipments you share.",
    ...
    homeWhatsNew: {
      ...
      title: "What’s new",
      lead: "Recent improvements to NaoLab — see the full list on the changelog page.",
  ...
  vesselsPage: {
    ...
    thSavedListHint:
      "Workspace status for saved containers on this vessel: active (still in progress) or completed (marked done).",
    savedListLegend:
