...
export function RegisterPage() {
  ...
  return (
    <AuthSplitLayout>
      <div className="auth-card auth-card--wide auth-card--comfort auth-card--panel">
        ...
        <div className="auth-paths" aria-label={t("auth.registerPathsAria")}>
          <p className="auth-paths__item">{t("auth.registerPathNew")}</p>
          <p className="auth-paths__item">{t("auth.registerPathStaff")}</p>
          <p className="auth-paths__item">{t("auth.registerPathClient")}</p>
        </div>
